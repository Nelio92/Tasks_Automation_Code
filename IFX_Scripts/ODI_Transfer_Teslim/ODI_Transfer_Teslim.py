...
CONFIG = OdiImportConfig(
	...
	#output_csv=Path(r"C:\UserData\Learning\Software_Programming\GitHub_Nelio92\Tasks_Automation_Code\IFX_Scripts\ODI_Transfer_Teslim\8188_ODIs_TX.csv"),
	...
	modules={"TXPA","TXPB","TXPC"},
	odi_columns={"ODI LTL S1","ODI UTL S1","ODI LTL S2","ODI UTL S2","ODI LTL B1","ODI UTL B1","ODI LTL B2","ODI UTL B2","ODI LTL Q1","ODI UTL Q1","ODI LTL Q2","ODI UTL Q2","ODI LTL Q3","ODI UTL Q3"},
	# Output metadata
	comment="Including the 8188 CV-ATE correlation factors for the Test-D releases",
	#jira_tasks="RSIPPTE-846",
	jira_tasks="PTE8144-448",
	odi_source="INS_OFF",
	test_variants="8144",
	#test_variants="8188",
)
