...
#img_path = 'C:/UserData/WinPython/Pics_S6/*.png' # The folder containing all your plots (CDF, Boxes and PCsites) arranged by Name
#img_path2 = 'C:/UserData/WinPython/Pics_S6/'
#img_sorted_path = 'C:/UserData/WinPython/Pics_Sorted_S6/'
img_path = 'C:/UserData/WinPython/Pics_S6_SHORT/*.png' # The folder containing all your plots (CDF, Boxes and PCsites) arranged by Name
img_path2 = 'C:/UserData/WinPython/Pics_S6_SHORT/'
img_sorted_path = 'C:/UserData/WinPython/Pics_Sorted_S6_SHORT/'
...
prs = Presentation('template_S6.pptx') # I took the template of Osama with just the COVER and BACK pages
slideLayout = prs.slide_layouts[6]
counter = 0
# Check the yield losses in Excel file
YL_CSV = pd.read_excel('yield_losses_all_tests_S6.xlsx', sheet_name="yield_losses_all_tests")
